var beatMapCache: Record<string, BeatMap>;
var currentBeatMap: BeatMap | null;
var beatMapNextIdx: number;
var beatMapBusy: boolean;
var beatMapToken: number;
var beatAnalysisTimer: ReturnType<typeof setTimeout> | null;
var beatAnalysisStartedAt: number;
var beatPrefetchTimer: ReturnType<typeof setTimeout> | null;
var beatPrefetchBusy: boolean;
var beatPrefetchToken: number;
var beatPrefetchLastKey: string;
var BEAT_PREFETCH_LIMIT: number;
var beatDiskCacheStatus: BeatDiskCacheStatus;
var beatDiskCacheNoticeLogged: boolean;
var djBeatMapCache: Record<string, BeatMap>;
var currentDjBeatMap: BeatMap | null;
var djBeatMapNextIdx: number;
var djBeatPulseNextIdx: number;
var djBeatMapBusy: boolean;
var djBeatMapToken: number;
var djBeatAnalysisTimer: ReturnType<typeof setTimeout> | null;
var beatAnalysisConfig: BeatAnalysisConfig;
var beatCam: BeatCameraState;
var liveCamAvg: number;
var liveCamPeak: number;
var liveCamLastRaw: number;
var cinemaDynamics: CinemaDynamics;
var cinemaTrackProfile: CinemaTrackProfile;
var rtBeat: RealtimeBeatState;
var djMode: DjModeState;
...
function beatEventTime(ev: BeatEventLike): number {
  return typeof ev === 'number' ? ev : (ev && isFinite(ev.time) ? ev.time : Infinity);
}

function __mineradioInitAudioRealtimeAnalysis23(): void {
  // v7.2: 离线节拍预解析
