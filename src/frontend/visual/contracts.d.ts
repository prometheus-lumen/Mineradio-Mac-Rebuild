...
interface FxSettings {
  ...
  topographyBands: number[];
  topographyEnabledBands: boolean[];
  topographyMotionSpeed: number;
  topographyAmplitude: number;
  topographyTerrainDensity: number;
  topographyFloatingBlocks: boolean;
  topographyFloatingIntensity: number;
  topographyFloatingMinSize: number;
  topographyFloatingMaxSize: number;
  topographyFloatingSpeed: number;
  topographyFloatingCount: number;
  topographyTheme: string;
  topographyBackgroundColor: string;
  topographyFogColor: string;
  topographyCoolColor: string;
  topographyWarmColor: string;
  topographyAccentColor: string;
  topographyGlowIntensity: number;
  cinemaShake: number;
