...
function __mineradioInitUiFxState24(): void {
  ...
  fxDefaults = {
    ...
    topographyEnabledBands: [true, true, true, true, true, true, true, true],
    topographyMotionSpeed: 50,
    topographyAmplitude: 50,
    topographyTerrainDensity: 46,
    topographyFloatingBlocks: true,
    topographyFloatingIntensity: 55,
    topographyFloatingMinSize: 9,
    topographyFloatingMaxSize: 26,
    topographyFloatingSpeed: 77,
    topographyFloatingCount: 80,
    topographyTheme: 'nocturnal',
    topographyBackgroundColor: '#03050A',
    topographyFogColor: '#03050A',
    topographyCoolColor: '#004DFF',
    topographyWarmColor: '#FF331A',
    topographyAccentColor: '#33E6FF',
    topographyGlowIntensity: 100,
    desktopLyrics: false,
