...
function normalizeFxArchiveSnapshot(raw: unknown): FxArchiveSnapshot | null {
  ...
  return {
    ...
    topographyEnabledBands: normalizeSonicTopographyEnabledBands(record.topographyEnabledBands),
    topographyMotionSpeed: archiveNumber(record, 'topographyMotionSpeed', fxDefaults.topographyMotionSpeed, 0, 100),
    topographyAmplitude: archiveNumber(record, 'topographyAmplitude', fxDefaults.topographyAmplitude, 0, 100),
    topographyTerrainDensity: archiveNumber(record, 'topographyTerrainDensity', fxDefaults.topographyTerrainDensity, 0, 100),
    topographyFloatingBlocks: record.topographyFloatingBlocks !== false,
    topographyFloatingIntensity: archiveNumber(record, 'topographyFloatingIntensity', fxDefaults.topographyFloatingIntensity, 0, 100),
    topographyFloatingMinSize: archiveNumber(record, 'topographyFloatingMinSize', fxDefaults.topographyFloatingMinSize, 0, 100),
    topographyFloatingMaxSize: archiveNumber(record, 'topographyFloatingMaxSize', fxDefaults.topographyFloatingMaxSize, 0, 100),
    topographyFloatingSpeed: archiveNumber(record, 'topographyFloatingSpeed', fxDefaults.topographyFloatingSpeed, 0, 100),
    topographyFloatingCount: archiveNumber(record, 'topographyFloatingCount', fxDefaults.topographyFloatingCount, 0, 100),
    topographyTheme: normalizeSonicTopographyThemeId(record.topographyTheme),
    topographyBackgroundColor: normalizeHexColor(record.topographyBackgroundColor || fxDefaults.topographyBackgroundColor, fxDefaults.topographyBackgroundColor),
    topographyFogColor: normalizeHexColor(record.topographyFogColor || fxDefaults.topographyFogColor, fxDefaults.topographyFogColor),
    topographyCoolColor: normalizeHexColor(record.topographyCoolColor || fxDefaults.topographyCoolColor, fxDefaults.topographyCoolColor),
    topographyWarmColor: normalizeHexColor(record.topographyWarmColor || fxDefaults.topographyWarmColor, fxDefaults.topographyWarmColor),
    topographyAccentColor: normalizeHexColor(record.topographyAccentColor || fxDefaults.topographyAccentColor, fxDefaults.topographyAccentColor),
    topographyGlowIntensity: archiveNumber(record, 'topographyGlowIntensity', fxDefaults.topographyGlowIntensity, 40, 220),
