...
function requestPlaylistCover(url: string, cb?: PlaylistCoverCallback) {
...
async function loadPlaylistIntoQueueById(id: string | number, autoplay = false, title = '') {
  if (!id) return;
